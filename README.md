...
The current version is **v4.3.1**, packaged as:

- **Linux** — [`KubeVerse-4.3.1-linux-x86_64.AppImage`](https://github.com/Rohitpr05/KubeVerse/releases/download/v4.3.1/KubeVerse-4.3.1-linux-x86_64.AppImage) (portable) or [`KubeVerse-4.3.1-linux-amd64.deb`](https://github.com/Rohitpr05/KubeVerse/releases/download/v4.3.1/KubeVerse-4.3.1-linux-amd64.deb) (system install)
- **Windows** — [`KubeVerse-4.3.1-win-x64.exe`](https://github.com/Rohitpr05/KubeVerse/releases/download/v4.3.1/KubeVerse-4.3.1-win-x64.exe) (installer)
...
1. Download `KubeVerse-4.3.1-linux-x86_64.AppImage` from the v4.3.1 GitHub Release.
2. Make it executable and run it:

```bash
chmod +x KubeVerse-4.3.1-linux-x86_64.AppImage
./KubeVerse-4.3.1-linux-x86_64.AppImage
```
...
`KubeVerse-4.3.1-linux-amd64.deb` is intended for Debian/Ubuntu-based distributions and installs KubeVerse with a proper application menu entry and dock icon:

```bash
sudo apt install ./KubeVerse-4.3.1-linux-amd64.deb
```
...
1. Open the [v4.3.1 GitHub Release](https://github.com/Rohitpr05/KubeVerse/releases).
2. Download `KubeVerse-4.3.1-win-x64.exe`.
